...
start_url = "https://en.wikipedia.org/wiki/Linear_algebra"
target_url = "https://en.wikipedia.org/wiki/Linear_independence"
...
def find_first_link(url):
    ...
    for element in content_div.find_all("p", recursive=False):
        ...
        if element.find("a", recursive=False):
            article_link = element.find_all("a", recursive=False)[1].get('href')
            break
